...
public class Ciudad implements Serializable {
    ...
    @OneToMany(mappedBy = "ciudadExpedicionDoc")
    private List<DatosEmpleado> datosEmpleadoList;
    @OneToMany(mappedBy = "idCiudad")
    private List<DatosEmpleado> datosEmpleadoList1;
    ...
    @XmlTransient
    public List<DatosEmpleado> getDatosEmpleadoList1() {
        return datosEmpleadoList1;
    }

    public void setDatosEmpleadoList1(List<DatosEmpleado> datosEmpleadoList1) {
        this.datosEmpleadoList1 = datosEmpleadoList1;
    }
