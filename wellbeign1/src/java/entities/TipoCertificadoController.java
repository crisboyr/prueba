...
public class TipoCertificadoController implements Serializable {
    ...
    private TipoCertificado current;
    private DataModel items = null;
    @EJB
    private entities.TipoCertificadoFacade ejbFacade;
    ...
    public TipoCertificado getSelected() {
        if (current == null) {
            current = new TipoCertificado();
            selectedItemIndex = -1;
        }
        return current;
    }

    private TipoCertificadoFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (TipoCertificado) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TipoCertificadoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TipoCertificadoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TipoCertificadoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class TipoCertificadoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            TipoCertificadoController controller = (TipoCertificadoController) facesContext.getApplication().getELResolver().
